...
const experienceCards: ExperienceCardData[] = [
  ...
  bullets: [
    ...
    'Led the integration of science and business modules to provide hands-on interdisciplinary learning.',
    'Enabled participants to apply scientific principles to real-world business challenges, strengthening problem-solving and innovation skills.',
  ],
  color: '#1c1914',
  borderColor: '#8A7344',
  rotation: 'rotate-0',
